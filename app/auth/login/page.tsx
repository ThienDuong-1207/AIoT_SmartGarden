             ...
             {!isAdminMode ? (
               <div className="space-y-4">
                 <button
                   ...
                   className="group relative flex w-full items-center justify-center gap-4 py-4 rounded-2xl bg-white/[0.03] border border-white/10 text-white font-bold text-xs uppercase tracking-widest transition-all duration-300 hover:bg-white/[0.07] hover:border-emerald-500/30 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.4)]"
                 >
                    <Image src="/window.svg" alt="Google" width={16} height={16} className="opacity-80 group-hover:opacity-100" />
