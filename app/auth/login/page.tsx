             ...
             {!isAdminMode ? (
               <div className="space-y-4">
                 <button
                   ...
                   className="flex w-full items-center justify-center gap-2 py-3 sm:py-4 rounded-2xl bg-emerald-500 text-white font-black text-[11px] sm:text-xs uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all duration-300 hover:bg-emerald-400 hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] hover:-translate-y-1"
                 >
                    ...
                    <ChevronRight size={14} className="animate-pulse hidden sm:inline" />
                 </button>
               </div>
             ) : (
